      ...
      <div className="max-w-6xl mx-auto bg-blue-100 shadow-lg rounded-lg overflow-hidden dark:bg-gray-800 dark:border-gray-700">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
          ...
          <div className='p-8 flex flex-col justify-center'>
            <h3 className='text-3xl font-bold text-gray-900 dark:text-white mb-4'> {project.nom}</h3>
            <p className='text-lg font-normal text-gray-700 dark:text-gray-300 mb-3'> <br/>{project.description}</p>
          </div>
        </div>
      </div>
    </div>
